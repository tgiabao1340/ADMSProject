...
public class HopDong {
	...
	public void formHopDong() throws InvalidFormatException {
		...
		try {
			...
			String dataPara11 = "Bên bán là chủ sở hữu của chiếc xe máy/xe môtô nhãn hiệu:" + m.getProductName()
					+ ". Loại xe:" + "\n\n" + m.getType() + ", màu sắc" + "\n\n" + m.getColor();
			...
			String dataPara12 = "2.1. Bên bán đồng ý bán và Bên mua đồng ý mua chiếc xe nói trên như hiện trạng với giá là:"
					+ "đồng và không thay đổi vì bất kỳ lý do gì.";
			...
			// String s= order.getOrderID().toString() + order.getDate().toString() ;
			// String url ="D:/" + s +".docx";
			FileOutputStream out = new FileOutputStream("D:\\data112.docx");
