...
public class Test {
	public static void main(String[] args) {
		...
		Supplier supplier = new Supplier("Thái Lan", "HONDA", "221 Nguyễn Văn Linh, phường 4, Quận 7",
				"0839869011", "324532");
		Supplier supplier2 = new Supplier("Ấn Độ", "YAMAHA", "12 Quốc Hương, phường Thảo Điền, Quận 2",
				"0839862222", "324235");
		Supplier supplier3 = new Supplier("Đài Loan", "SYM", "138-140 Hai Bà Trưng, phường Bến Nghé, Quận 1",
				"0839864181", "324352");
		Supplier supplier4 = new Supplier("Nhật Bản", "SUZUKI", "12 Hoàng Diệu, phường 4, Quận 4",
				"0839860909", "324325");
		...
		Order order = new Order(LocalDate.now(), e, customer, "");
		Order order1 = new Order(LocalDate.now(), null, null, "");
		Order order2 = new Order(LocalDate.now(), e1, customer2, "");
		Order order3 = new Order(LocalDate.now(), e1, customer, "");
		Order order4 = new Order(LocalDate.now(), e1, customer, "");
		Order order5 = new Order(LocalDate.now(), e2, customer, "");
		Order order6 = new Order(LocalDate.now(), e1, customer, "");

	
		OrderDetail detail = new OrderDetail(order1, motorbike, "", motorbike.getUnitPrice(), 1, 0.1, "Trắng");
		OrderDetail detail1 = new OrderDetail(order1, motorbike,"", motorbike.getUnitPrice(), 1, 0.1, "Xanh");
		OrderDetail detail2 = new OrderDetail(order2, motorbike2, "", motorbike.getUnitPrice(), 1, 0.1, "Đỏ");
		OrderDetail detail3 = new OrderDetail(order3, motorbike3, "", motorbike.getUnitPrice(), 1, 0.1, "Đen");
		OrderDetail detail4 = new OrderDetail(order4, motorbike4, "", motorbike.getUnitPrice(), 1, 0.1, "Vàng");
		OrderDetail detail5 = new OrderDetail(order5, motorbike5, "", motorbike.getUnitPrice(), 1, 0.1, "Trắng");
		OrderDetail detail6 = new OrderDetail(order6, motorbike6, "", motorbike.getUnitPrice(), 1, 0.1, "Đen");
